...
<head>
  ...
  <style>
    ...
    .faq-icon {
      width: 12px;
      height: 12px;
      border-right: 2px solid #8E2C18;
      border-bottom: 2px solid #8E2C18;
...
<body>
  ...
  <section class="hero" id="beranda">
    ...
    <div class="hero-content">
      ...
      <p>
        SIMAPARE hadir sebagai platform resmi yang mempermudah proses pendaftaran, pemantauan,
        dan pengelolaan magang di Pengadilan Negeri Parepare. Melalui sistem ini, pelajar dapat
        mengakses informasi terbaru seputar program magang, jadwal, serta panduan administrasi
  ...
  <section class="about-section" id="tentang">
    ...
    <p>SIMAPARE (Sistem Informasi Magang Pengadilan Negeri Parepare) merupakan inovasi digital yang dikembangkan sebagai platform resmi untuk mempermudah proses pendaftaran, pemantauan, dan pengelolaan kegiatan magang di lingkungan Pengadilan Negeri Parepare. Sistem ini hadir sebagai bentuk komitmen lembaga peradilan dalam mewujudkan pelayanan publik yang modern, transparan, dan berbasis teknologi informasi.</p>
      ...
      <p>Kehadiran SIMAPARE diharapkan dapat meningkatkan kualitas penyelenggaraan program magang dengan memberikan kemudahan akses, kejelasan informasi, dan transparansi proses bagi seluruh pihak yang terlibat. Melalui sistem ini, Pengadilan Negeri Parepare berupaya menciptakan lingkungan magang yang profesional, terstruktur, dan mendukung pengembangan kompetensi pelajar maupun mahasiswa dalam memahami mekanisme kerja peradilan.</p>
